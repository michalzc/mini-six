...
export class WeaponDataModel extends foundry.abstract.DataModel {
  static defineSchema() {
    return {
      ...
      damage: diceValue(),
      status: new fields.StringField({ choices: SYSTEM.WEAPON_STATUSES, initial: 'carried' }),
    };
  }
}
...
export class ArmourDataModel extends foundry.abstract.DataModel {
  static defineSchema() {
    return {
      ...
      status: new fields.StringField({ choices: SYSTEM.ARMOUR_STATUSES, initial: 'carried' }),
    };
  }
}
...
export class GearDataModel extends foundry.abstract.DataModel {
  static defineSchema() {
    return {
      description: new fields.HTMLField(),
      characteristics: gearCharacteristicsSchema(),
      status: new fields.StringField({ choices: SYSTEM.GEAR_STATUSES, initial: 'carried' }),
    };
  }
}
